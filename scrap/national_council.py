...
def scrap_national_council() -> ScrapResult:
    """열린국회정보 Open API를 이용해 제21대 국회의원 인적사항 스크랩
    ...
    request_url = f"https://open.assembly.go.kr/portal/openapi/nwvrqwxyaytdsfvhu?KEY={assembly_key}&pSize=500"
...
if __name__ == "__main__":
    result = scrap_national_council()
    print(len(result.councilors))
