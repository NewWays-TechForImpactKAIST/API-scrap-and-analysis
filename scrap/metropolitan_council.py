...
def scrap_metro_2(cid, url="https://council.busan.go.kr/council/past02") -> ScrapResult:
...
def scrap_metro_14(cid, url="https://council.gb.go.kr/kr/member/name") -> ScrapResult:
